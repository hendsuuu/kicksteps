...
const page = () => {
  return (
    ...
    <div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm'>
        ...
        <div>
            <button type="submit" className='flex w-full justify-center rounded-md bg-[#1979BB] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 '>Register</button>
        </div>
        </form>

        <p className='mt-10 text-center text-sm text-gray-500'>
        sudah punya akun?
        <a href="/" className='font-semibold leading-6 text-[#1979BB] hover:text-blue-500'>Login</a>
        </p>
    </div>
    </div>
</div>
